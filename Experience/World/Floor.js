...
export default class Floor {
   ...
   setCicrles() {
      ...
      const material = new THREE.MeshBasicMaterial({ color: 0xe5a1aa });
      const material2 = new THREE.MeshBasicMaterial({ color: 0x8395cd });
      const material3 = new THREE.MeshBasicMaterial({ color: 0x7ad0ac });
